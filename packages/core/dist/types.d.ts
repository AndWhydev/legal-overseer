...
export type AgentType = 'lead-swarm' | 'invoice-flow' | 'channel-triage' | 'client-comms' | 'proposal-bot' | 'ad-script-gen' | 'client-onboarding' | 'ai-search-optimizer' | 'tender-hunter' | 'sentry';
...
export interface ChannelAdapter {
    ...
    send?: (message: Omit<ChannelMessage, 'id' | 'timestamp'>) => Promise<{
        success: boolean;
        id?: string;
    }>;
