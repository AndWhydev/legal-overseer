...
function HeroArt() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <svg className="absolute right-1/3 top-1/4 h-3 w-3 animate-float-gentle opacity-15" viewBox="0 0 16 16">
        <circle cx="8" cy="8" r="6" fill="#8b6f47" />
      </svg>
      <svg className="absolute right-1/4 bottom-1/3 h-5 w-5 animate-float-slow opacity-10" viewBox="0 0 16 16">
...
function SketchIcon({ type }: { type: "communication" | "operations" | "intelligence" }) {
  if (type === "communication") {
    return (
      <svg viewBox="0 0 48 48" fill="none" className="h-10 w-10">
        <rect x="6" y="10" width="36" height="24" rx="3" stroke="#d97757" strokeWidth="1.5" strokeDasharray="4 2" />
        <path d="M 6 14 L 24 26 L 42 14" stroke="#d97757" strokeWidth="1.5" strokeLinecap="round" />
        <circle cx="38" cy="12" r="5" fill="#d97757" fillOpacity="0.15" stroke="#d97757" strokeWidth="1" />
      </svg>
    );
  }
  if (type === "operations") {
    return (
      <svg viewBox="0 0 48 48" fill="none" className="h-10 w-10">
        <circle cx="24" cy="24" r="16" stroke="#d97757" strokeWidth="1.5" strokeDasharray="3 3" />
        <path d="M 24 12 L 24 24 L 32 28" stroke="#d97757" strokeWidth="1.5" strokeLinecap="round" />
        <circle cx="24" cy="24" r="2" fill="#d97757" />
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className="h-10 w-10">
      <circle cx="24" cy="18" r="8" stroke="#d97757" strokeWidth="1.5" />
      <path d="M 16 18 Q 20 24, 24 18 Q 28 12, 32 18" stroke="#d97757" strokeWidth="1" strokeDasharray="2 2" />
      <path d="M 12 36 C 12 30, 18 26, 24 26 C 30 26, 36 30, 36 36" stroke="#d97757" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 2" />
    ...
    <nav className="landing-nav fixed top-0 left-0 right-0 z-50 border-b border-[#e8e4dc] bg-[#faf9f0]/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 text-[13px] text-[#6b6560] md:flex">
          ...
          <Link href="/login" className="transition-colors hover:text-[#1a1a1a]">Sign in</Link>
        </div>

        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="inline-flex h-10 items-center gap-1.5 rounded-md bg-[#d97757] px-5 text-[13px] font-semibold text-white shadow-[0_8px_24px_rgba(217,119,87,0.35)] transition-colors hover:bg-[#c4684a]"
          >
            Sign in
          </Link>
        </div>
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <BlurFade delay={0.2}>
          ...
          >
            An AI that knows
            <br />
            <em className="text-[#d97757]">your world.</em>
          </h1>
        </BlurFade>
        ...
        <BlurFade delay={0.5}>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/login"
              className="inline-flex h-14 items-center gap-2 rounded-md bg-[#d97757] px-10 text-[16px] font-semibold text-white shadow-[0_12px_34px_rgba(217,119,87,0.45)] transition-colors hover:bg-[#c4684a]"
            >
              Sign in
            ...
            <a
              href="#how-it-works"
              className="inline-flex h-12 items-center gap-2 rounded-md border border-[#e8e4dc] bg-white px-8 text-[15px] font-medium text-[#5b5751] transition-colors hover:border-[#d4cfc6] hover:bg-[#f5f3ea]"
            >
              See how it works
            </a>
          </div>
          ...
          <BlurFade delay={0.1}>
            <div>
              ...
              >
                Human-first AI
                <br />
                <span className="text-[#d97757]">that works with your life</span>
              </h2>
          ...
          <BlurFade delay={0.2}>
            <div className="relative">
              ...
              <svg viewBox="0 0 400 300" fill="none" className="w-full">
                {/* Central node */}
                <circle cx="200" cy="150" r="30" stroke="#d97757" strokeWidth="2" />
                <text x="200" y="155" textAnchor="middle" fill="#d97757" fontSize="12" fontWeight="600">You</text>
                ...
                <path d="M 98 92 Q 140 110 172 138" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
                <path d="M 302 92 Q 260 110 228 138" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
                <path d="M 98 208 Q 140 190 172 162" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
                <path d="M 302 208 Q 260 190 228 162" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
                <path d="M 200 58 L 200 120" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
                <path d="M 200 180 L 200 242" stroke="#d97757" strokeWidth="1" strokeDasharray="4 3" opacity="0.4" />
              </svg>
            </div>
          </BlurFade>
        </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-16 lg:grid-cols-[1fr_1.5fr]">
          ...
          <div className="relative">
            ...
            <div className="absolute left-5 top-2 bottom-2 w-px bg-gradient-to-b from-[#d97757]/40 via-[#d97757]/20 to-transparent" />
