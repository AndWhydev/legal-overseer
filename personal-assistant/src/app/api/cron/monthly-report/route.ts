...
/**
 * Cron endpoint for auto-generating monthly reports for all active orgs.
 * Runs on the 1st of each month. Stores PDF and notifies org admins.
 */
export async function GET(request: Request) {
  ...
  for (const org of orgs ?? []) {
    try {
      ...
      // Notify org admins via notification dispatcher
