...
export const DEFAULT_CAPABILITIES: Record<AgentRole, CapabilityBoundary> = {
  sales: {
    ...
    allowedSkills: [
      ...
      'b2b-copywriting', 'competitor-alternatives', 'pricing-strategy', 'copywriting',
    ],
    deniedTools: ['generate_invoice', 'send_email'],
  },
  finance: {
    allowedToolGroups: ['core', 'memory'],
    allowedSkills: ['pricing-strategy'],
  ...
  operations: {
    ...
    allowedSkills: [
      ...
      'frontend-delight', 'frontend-distill', 'frontend-onboard', 'frontend-polish',
      'frontend-overdrive',
    ],
  ...
  research: {
    ...
    allowedSkills: [
      ...
      'creative-strategist',
      'competitor-alternatives', 'pricing-strategy',
    ],
    deniedTools: ['send_email', 'send_sms', 'generate_invoice', 'create_task'],
  },
  coordinator: {
    allowedToolGroups: ['core', 'memory'],
    allowedSkills: ['marketing-orchestrator', 'creative-orchestrator', 'frontend-orchestrator'],
    deniedTools: [],
  },
}
