...
const PlanOutputSchema = z.object({
  ...
  toolGroups: z.array(z.string())
    .describe('Tool groups needed (do NOT include "core" — it is always added). Available: memory, channel, web, comms, agentic, composio'),
...
Available groups: core (always included automatically), memory, channel, web, comms, creative, composio
Select 1-3 additional groups beyond core.
Use "composio" when the user wants to interact with third-party apps (HubSpot, Notion, Jira, Salesforce, Slack, Xero, etc.) or connect new integrations.
...
- "Create a contact in HubSpot" -> ["composio"]
- "Post to our Slack channel" -> ["composio"]
- "Connect my Notion" -> ["composio"]
