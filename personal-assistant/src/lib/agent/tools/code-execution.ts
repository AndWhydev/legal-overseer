...
- channels.list() / channels.getConfig(type)
...
Example: "const contacts = await sdk.contacts.list(); sdk.log('Found', contacts.length, 'contacts'); return contacts.map(c => c.name);"`,
    input_schema: {
