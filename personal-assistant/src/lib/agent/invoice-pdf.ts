...
export function generateInvoicePdf(
  ...
  const bankDetails = orgSettings?.bank_details?.trim() || 'Bank details available on request'
...
<html>
  ...
  <body style="font-family:Arial,Helvetica,sans-serif;background:#f8fafc;color:#0f172a;margin:0;padding:24px;">
    <div style="max-width:760px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
      <header style="padding:24px;border-bottom:1px solid #e2e8f0;background:#f8fafc;display:flex;justify-content:space-between;align-items:flex-start;gap:16px;">
        <div>
      ...
      <section style="padding:0 24px 24px;">
        ...
        <div style="margin-top:20px;display:flex;justify-content:flex-end;">
          <table style="width:280px;border-collapse:collapse;font-size:14px;">
            ...
            <tr>
              <td style="padding:8px 0;color:#475569;">GST (10%)</td>
              <td style="padding:8px 0;text-align:right;">${formatMoney(invoice.tax, invoice.currency)}</td>
            </tr>
            <tr>
