  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          { label: 'CMS', content: <span className={cn('text-sm font-medium', signals.cms ? 'text-foreground' : 'text-muted-foreground')}>{signals.cms ?? 'Unknown'}</span> },
          ...
          <div key={cell.label} className="flex flex-col items-center gap-1 rounded-lg bg-muted p-3">
