  ...
  return (
    <HoverCardTrigger asChild>
      <a
        ...
        className={cn(
          "bg-muted text-muted-foreground hover:bg-muted-foreground/30 hover:text-primary inline-flex h-5 max-w-32 items-center gap-1 overflow-hidden rounded-full py-0 text-sm no-underline transition-colors duration-150",
