...
import { Inbox, Maximize2, CheckCircle2, ChevronRight, ChevronLeft } from 'lucide-react';
...
function GmailIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(234, 67, 53, 0.7)' }}>
...
function OutlookIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(0, 120, 212, 0.7)' }}>
...
function WhatsAppIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(37, 211, 102, 0.7)' }}>
...
function IMessageIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(52, 199, 89, 0.7)' }}>
...
function AsanaIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(240, 106, 106, 0.7)' }}>
...
function StripeIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(99, 91, 255, 0.7)' }}>
...
function SlackIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(230, 0, 35, 0.7)' }}>
...
function CalendarIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(0, 107, 255, 0.7)' }}>
...
function SMSIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(100, 200, 255, 0.7)' }}>
    ...
    >
      ...
      >
        <button
          ...
          aria-label={isCollapsed ? 'Expand inbox' : 'Collapse inbox'}
        >
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 4, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{ padding: 4 }}
            aria-label="Expand inbox full screen"
          >
            <Maximize2 size={13} />
          </button>
        </div>
