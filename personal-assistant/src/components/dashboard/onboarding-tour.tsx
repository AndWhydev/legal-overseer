...
import { SFXmark, SFArrowRight, SFArrowLeft, SFGaugeWithNeedle, SFHandRaised, SFCheckmarkShield, SFGear } from 'sf-symbols-lib';
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              >
                {isLast ? "Let's go!" : 'Next'} {!isLast && <SFArrowRight size={14} />}
              </button>
            </div>
          </div>
