...
export function InvoiceArtifact({
  ...
  return (
    <div style={card}>
      <div style={header}>
        <div>
          <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--text-primary, #E2E8F0)', letterSpacing: '-0.01em' }}>
            Invoice {invoiceNumber}
          </div>
          <div style={{ fontSize: 14, color: 'var(--text-dim, #64748B)', marginTop: 2 }}>
            {recipient} · {total}
          </div>
        </div>
      ...
      <div style={actionBar}>
        <div style={{ fontSize: 14, color: 'var(--text-dim, #64748B)', flex: 1, minWidth: 0, lineHeight: 1.4 }}>
          {description}
