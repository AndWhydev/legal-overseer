...
function SidebarFooter({ className, ...props }: SidebarFooterProps) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn('border-sidebar-border/70 flex flex-col gap-2 border-t p-2 pt-3', className)}
      {...props}
    />
  );
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-lg px-2 text-sm font-medium outline-hidden transition-[margin,opacity] duration-300 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuItem({ className, ...props }: SidebarMenuItemProps) {
  return (
    <li
      ...
      className={cn('group/menu-item relative overflow-hidden rounded-lg', className)}
      {...props}
    />
  );
}
...
function SidebarMenuBadge({ className, ...props }: SidebarMenuBadgeProps) {
  return (
    <div
      ...
      className={cn(
        'text-sidebar-foreground pointer-events-none absolute right-1 z-[1] flex h-5 min-w-5 items-center justify-center rounded-lg px-1 text-sm font-medium tabular-nums select-none',
...
function SidebarMenuSubButton({
  ...
  return (
    <HighlightItem activeClassName="bg-sidebar-accent text-sidebar-accent-foreground rounded-lg">
      <Comp
