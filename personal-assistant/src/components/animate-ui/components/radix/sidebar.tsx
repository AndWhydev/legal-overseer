...
function SidebarMenuBadge({ className, ...props }: SidebarMenuBadgeProps) {
  return (
    <div
      ...
      className={cn(
        'text-sidebar-foreground pointer-events-none absolute right-1 z-[1] flex h-5 min-w-5 items-center justify-center rounded-lg px-1 text-xs font-medium tabular-nums select-none',
