    ...
    <div className={className}>
      <Markdown
        ...
        components={{
          ...
          // Table elements
          table: ({ children }) => (
            <div className="my-3 overflow-x-auto rounded-lg border border-border overflow-hidden">
          ...
          th: ({ children }) => <th className="px-3 py-2 text-left text-sm font-medium text-muted-foreground">{children}</th>,
