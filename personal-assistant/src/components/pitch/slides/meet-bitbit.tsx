  ...
  return (
    <Slide>
      ...
      <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-600">
        ...
        invoices, follows up with your clients. It knows who Dave is, that he
        owes you money, and that he mentioned Steve's project last Tuesday. You
        can message it from WhatsApp while you're on a job site. It tells you
